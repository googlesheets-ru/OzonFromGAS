...
export declare class V4<SecurityDataType = unknown> {
     ...
     */
    productApiGetUploadQuota: (data: V1Empty, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ProductApiGetUploadQuotaData, ProductApiGetUploadQuotaError>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    productApiGetProductInfoPricesV4: (data: Productv4GetProductInfoPricesV4Request, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ProductApiGetProductInfoPricesV4Data, ProductApiGetProductInfoPricesV4Error>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    postingApiFbsPostingProductExemplarValidate: (data: Postingv4FbsPostingProductExemplarValidateRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<PostingApiFbsPostingProductExemplarValidateData, PostingApiFbsPostingProductExemplarValidateError>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    postingApiSetProductExemplar: (data: Fbsv4SetProductExemplarRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<PostingApiSetProductExemplarData, PostingApiSetProductExemplarError>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    postingApiGetProductExemplarStatus: (data: Fbsv4GetProductExemplarStatusRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<PostingApiGetProductExemplarStatusData, PostingApiGetProductExemplarStatusError>>;
    /**
     ...
     */
    postingApiShipFbsPostingV4: (data: Fbsv4FbsPostingShipV4Request, params?: RequestParams) => Promise<import("./http-client").HttpResponse<PostingApiShipFbsPostingV4Data, PostingApiShipFbsPostingV4Error>>;
}
