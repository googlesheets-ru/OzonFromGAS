import { Financev3FinanceTransactionListV3Request, Financev3FinanceTransactionTotalsV3Request, Postingv3GetFbsPostingListRequest, Postingv3GetFbsPostingRequest, Postingv3GetFbsPostingUnfulfilledListRequest, Postingv3PostingMultiBoxQtySetV3Request, Productv3GetProductListRequest, V3ChatHistoryRequest, V3ChatList, V3GetProductInfoListRequest, V3ImportProductsRequest, V3SupplyOrderGetRequest, V3SupplyOrderListRequest } from './data-contracts';
...
export declare class V3<SecurityDataType = unknown> {
     ...
     */
    productApiImportProductsV3: (data: V3ImportProductsRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3ImportProductsResponse, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    productApiGetProductList: (data: Productv3GetProductListRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").Productv3GetProductListResponse, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    productApiGetProductInfoList: (data: V3GetProductInfoListRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3GetProductInfoListResponse, import("./data-contracts").RpcStatus>>;
    /**
     ...
     */
    supplyOrderList: (data: V3SupplyOrderListRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3SupplyOrderListResponse, import("./data-contracts").RpcStatus>>;
    /**
     * @description Учитываются заявки с поставкой на конкретный склад и через [виртуальный распределительный центр (вРЦ)](https://seller-edu.ozon.ru/fbo/scheme-of-work/about#чем-отличаются-процессы-при-заявках-через-врц-и-напрямую-на-склад).
     *
     * @tags FBO
     ...
     * @response `default` `RpcStatus` Ошибка
     */
    supplyOrderGet: (data: V3SupplyOrderGetRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3SupplyOrderGetResponse, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    postingApiGetFbsPostingUnfulfilledList: (data: Postingv3GetFbsPostingUnfulfilledListRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").Postingv3GetFbsPostingUnfulfilledListResponse, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    postingApiGetFbsPostingListV3: (data: Postingv3GetFbsPostingListRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3GetFbsPostingListResponseV3, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    postingApiGetFbsPostingV3: (data: Postingv3GetFbsPostingRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3GetFbsPostingResponseV3, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    postingApiPostingMultiBoxQtySetV3: (data: Postingv3PostingMultiBoxQtySetV3Request, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").Postingv3PostingMultiBoxQtySetV3Response, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    chatApiChatListV3: (data: V3ChatList, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3ChatListResponse, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    chatApiChatHistoryV3: (data: V3ChatHistoryRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").V3ChatHistoryResponse, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    financeApiFinanceTransactionListV3: (data: Financev3FinanceTransactionListV3Request, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").Financev3FinanceTransactionListV3Response, import("./data-contracts").RpcStatus>>;
    /**
     ...
     * @response `500` `RpcStatus` Внутренняя ошибка сервера
     */
    financeApiFinanceTransactionTotalV3: (data: Financev3FinanceTransactionTotalsV3Request, params?: RequestParams) => Promise<import("./http-client").HttpResponse<import("./data-contracts").Financev3FinanceTransactionTotalsV3Response, import("./data-contracts").RpcStatus>>;
}
