var Ozon_;
(function (Ozon_) {
    class OzonRequestError extends Error {
    ...
    Ozon_.OzonRequestError = OzonRequestError;
    /**
     * @class Client
    ...
    class Client {
        ...
        qsBuilder(data, prefix, otherKey) {
            const qsItems = [];
            ...
            for (const key in data) {
                ...
                if (valueType === 'Date') {
                    qsItems.push(`${prefix}${otherKey || key}=${data[key].toISOString()}`);
                }
                if (valueType === 'Object') {
        ...
        request(init) {
            ...
            if (response.getResponseCode() > 299) {
                const errorDetails = JSON.parse(responseJson);
    ...
    class Api extends Client {
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiGetProductInfoV3(data) {
            const response = this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiGetProductInfoListV2(data) {
            const response = this.request({
         ...
         */
        productApiGetProductInfoListV3(data) {
            const response = this.request({
         ...
         */
        productApiGetProductInfoPricesV4(data) {
            const response = this.request({
         ...
         */
        productApiGetProductInfoPrices(data) {
            const response = this.request({
         ...
         */
        productApiImportProductsPrices(data) {
            const response = this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        analyticsApiAnalyticsGetStockOnWarehousesV2(data) {
            const response = this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiProductUpdateOfferId(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiImportProductsV2(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiGetImportProductsInfo(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiGetProductAttributesV3(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiImportProductsStocks(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiImportProductsStocksV2(data) {
            return this.request({
         ...
         */
        warehouseApiWarehouseList(data) {
            const response = this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        productApiProductsStocksV2(data) {
            const response = this.request({
                endpoint: `/v2/products/stocks`,
                method: 'POST',
                payload: data,
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        financeApiFinanceTransactionListV3(data) {
            const response = this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        financeApiFinanceTransactionTotalV3(data) {
            const response = this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        warehouseApiDeliveryMethodListV2(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        carriageApiCarriageDeliveryListV2(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        postingApiPostingFbsActCheckStatus(data) {
            return this.request({
         ...
         * @response `500` `RpcStatus` Внутренняя ошибка сервера
         */
        postingApiPostingFbsGetAct(data) {
            return this.request({
